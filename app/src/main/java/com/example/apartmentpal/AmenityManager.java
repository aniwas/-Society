...
public class AmenityManager extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amenity_manager);
        ...
        gymButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showTimeSlotSelectionWindow(amenityHelper.getBookedTimeSlots("Gym"),"Gym"); // Assuming Gym is the first amenity
            }
        });
        ...
        swimmingPoolButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showTimeSlotSelectionWindow(amenityHelper.getBookedTimeSlots("Swimming Pool"),"Swimming Pool"); // Assuming Gym is the first amenity
            }
        });
        ...
        groundButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showTimeSlotSelectionWindow(amenityHelper.getBookedTimeSlots("Ground"),"Ground"); // Assuming Gym is the first amenity
            }
        });
        ...
        partyHallButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showTimeSlotSelectionWindow(amenityHelper.getBookedTimeSlots("Party Hall"),"Party Hall"); // Assuming Gym is the first amenity
            }
        });
    }
    private void showTimeSlotSelectionWindow(List<String> availableSlots, String aminety) {
        ...
        View dialogView = inflater.inflate(R.layout.time_slot_deselection, null);
        ...
        buttonBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedRadioButtonId != -1) {
                    ...
                    boolean temp;
                    if(selectedTimeSlot.equals("9AM TO 12PM")) temp = amenityHelper.cancelTimeSlot("slot9AMto12PM",aminety);
                    else if(selectedTimeSlot.equals("12PM TO 3PM")) amenityHelper.cancelTimeSlot("slot12PMto3PM",aminety);
                    else if(selectedTimeSlot.equals("3PM TO 6PM")) amenityHelper.cancelTimeSlot("slot3PMto6PM",aminety);
                    alertDialog.dismiss(); // Close the dialog after booking
                } else {
                    // Handle case when no radio button is selected
                    Toast.makeText(AmenityManager.this, "Please select a time slot", Toast.LENGTH_SHORT).show();
                }
            }
        });
